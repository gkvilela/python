#title
print('Calculo mensal de pagamento DARF: Ações - Swing Trade')
...
#conditions
if venda > limite:
    print('Seu lucro foi de R$ {:.2f}, com isso terá de pagar um DARF para ações em Swing Trade de R$ {:.2f}' .format(lucro,darf))
